#!/usr/bin/env python3
"""Run the PoDManager-vs-BMC extraction pipeline into output/<date>/."""
...
def output_paths(out_dir: Path, podm: Path, bmc: Path) -> dict[str, Path]:
    return {
        "podm_interface_list": out_dir / "podm.interface-list.yaml",
        "bmc_interface_list": out_dir / "bmc.interface-list.yaml",
